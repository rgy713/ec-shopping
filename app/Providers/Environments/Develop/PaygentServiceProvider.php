...
class PaygentServiceProvider extends ServiceProvider
{
    ...
    public function register(){
        //開発環境では実際の決済を行うことはできないが、PaygentB2BModuleインスタンス取得できるように設定。
        $this->app->bind(PaygentB2BModule::class,function($app){
             ...
             */
            $paygentPrivateApp['const']['PaygentB2BModuleResources__PROPERTIES_FILE_NAME']="/../../../../../../app/Environments/Develop/Payment/Paygent/modenv_properties.php";
        ...
        //開発環境用のペイジェントサービスクラス
        $this->app->bind(PaygentInterface::class,\App\Environments\Develop\Payment\Paygent\PaygentStubService::class);
