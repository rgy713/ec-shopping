...
class PaygentServiceProvider extends ServiceProvider
{
    ...
    public function register(){
        //テスト実行時は実際の決済を行うことはできないが、PaygentB2BModuleインスタンスは取得できるように設定。
        $this->app->bind(PaygentB2BModule::class,function($app){
             ...
             */
            $paygentPrivateApp['const']['PaygentB2BModuleResources__PROPERTIES_FILE_NAME']="/../../../../../../app/Environments/Testing/Payment/Paygent/modenv_properties.php";
        ...
        //テスト実行時用のペイジェントサービスクラス
        $this->app->bind(PaygentInterface::class,\App\Environments\Testing\Payment\Paygent\PaygentStubService::class);
