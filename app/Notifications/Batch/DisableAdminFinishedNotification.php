...
class DisableAdminFinishedNotification extends OperationAdminNotification
{
    ...
    {
        $templateMail = new TemplateMail(1010);//管理アカウント無効化バッチ成功メールID
    ...
    public function getSystemMessage($notifiable): SystemMessage
    {
        ...
        $systemMessage->message = "管理アカウント無効化バッチ処理を完了しました。";
