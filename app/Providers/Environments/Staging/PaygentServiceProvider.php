...
class PaygentServiceProvider extends ServiceProvider
{
    ...
    public function register(){
        ...
        $this->app->bind(PaygentB2BModule::class,function($app){
             ...
             */
            $paygentPrivateApp['const']['PaygentB2BModuleResources__PROPERTIES_FILE_NAME']="/../../../../../../app/Environments/Staging/Payment/Paygent/modenv_properties.php";
        ...
        //ステージング環境用のペイジェントサービスクラス
        $this->app->bind(PaygentInterface::class,\App\Environments\Staging\Payment\Paygent\PaygentService::class);
