...
class AdvertisingMedia extends Model implements KeyValueListModelInterface
{
    ...
    public function summaryGroup()
    {
        return $this->hasMany(AdvertisingMediaSummaryGroupAdvertisingMedia::class, 'advertising_medium_id', 'id');
    }
}
