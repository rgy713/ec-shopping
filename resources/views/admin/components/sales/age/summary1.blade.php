...
<div class="card">
    <div class="card-header">
        {{__("admin.page_header_name.summary_age")}}
        ...
        <div class="row">
            <div class="col-12">
                ...
                <table class="table table-sm table-bordered">
                    <tr>
                        <th>{{__("admin.item_name.sales.age")}}</th>
                    ...
                    @foreach($result as $count=>$summary)
                        <tr>
                            <th>{{$summary->customer_age}}{{__("admin.item_name.sales.age_unit")}}</th>
                            <td>{{$summary->count}}</td>
                            <td>{{$summary->total}}</td>
                            <td>
                                <button class="btn btn-sm btn-primary" @click.prevent="csv_download({{$summary->customer_age}})">
