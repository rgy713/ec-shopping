...
class BundleShippingFinishedNotification extends OperationAdminNotification
{
    ...
    {
        $templateMail = new TemplateMail(1005);//まとめ配送バッチ完了メールのID
    ...
    public function getSystemMessage($notifiable): SystemMessage
    {
        ...
        $systemMessage->message = "まとめ配送バッチ処理が完了しました。";
